...
import requests
from backend_api.constants import TRAIN_TABULAR_MODEL, MODEL_NAME_KEY, TARGET_COLUMN_NAME_KEY, FILE_KEY
...
def train_model(request):
    ...
    with open(uploaded_file_path, 'rb') as f:
        response = requests.post(TRAIN_TABULAR_MODEL,
                                 files = {FILE_KEY: f},
                                 data={MODEL_NAME_KEY: model_name, TARGET_COLUMN_NAME_KEY: target_column_name})
